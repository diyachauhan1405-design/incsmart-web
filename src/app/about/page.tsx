...
const journeySteps = [
  ...
  { year: "2018", label: "First Industrial IoT Deployment" },
  { year: "2020", label: "Cloud Monitoring Platform Launched" },
  { year: "2022", label: "Enterprise Expansion" },
  { year: "2025", label: "120+ Projects Delivered" }
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5 flex flex-col space-y-6">
                ...
                <div className="flex items-center gap-4">
                  <Link href="/solutions" className="bg-brand-blue hover:bg-blue-600 active:scale-95 text-white rounded-lg px-6 py-3 text-xs font-bold transition-all shadow-md flex items-center gap-2">
              ...
              <div className="lg:col-span-7 relative flex justify-center">
                <div className="relative w-full aspect-[4/3] rounded-3xl border border-white/5 bg-[#081325]/30 p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden group">
                  ...
                  <Image 
                    src={cloudDiagram} 
                    alt="INCSMART Cloud Connections Overview Diagram" 
                    fill 
                    className="object-contain opacity-90 group-hover:scale-[1.01] transition-transform duration-500"
                    priority
                  />

                  {/* Absolute hotspots matching the image */}
                  <div className="absolute top-[8%] left-[60%] bg-[#081325]/90 border border-white/10 rounded-full px-3 py-1.5 text-[8px] font-bold text-slate-300 backdrop-blur-md hidden md:block">
                    SaaS Platform
                  </div>
                  <div className="absolute top-[30%] left-[50%] bg-[#081325]/90 border border-white/10 rounded-full px-3 py-1.5 text-[8px] font-bold text-slate-300 backdrop-blur-md hidden md:block">
                    Hospital
                  </div>
                  <div className="absolute top-[48%] left-[42%] bg-[#081325]/90 border border-white/10 rounded-full px-3 py-1.5 text-[8px] font-bold text-slate-300 backdrop-blur-md hidden md:block">
                    Factory
                  </div>
                  <div className="absolute top-[68%] left-[38%] bg-[#081325]/90 border border-white/10 rounded-full px-3 py-1.5 text-[8px] font-bold text-slate-300 backdrop-blur-md hidden md:block">
                    Railway
                  </div>
                  <div className="absolute bottom-[10%] right-[10%] bg-[#081325]/90 border border-white/10 rounded-full px-3 py-1.5 text-[8px] font-bold text-slate-300 backdrop-blur-md hidden md:block">
                    Commercial Building
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-6 flex flex-col space-y-6">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mt-1 font-heading">Milestones & History</h3>
                </div>

                <div className="relative border-l border-white/10 pl-6 space-y-8 mt-6">
                  {journeySteps.map((step, i) => (
                    <div key={i} className="relative group">
                      <div className="absolute -left-[31px] top-1 w-4 h-4 rounded-full bg-brand-blue border-4 border-[#07111D] group-hover:scale-110 transition-transform"></div>
                      <div className="text-xs font-bold text-brand-blue">{step.year}</div>
              ...
              <div className="lg:col-span-6 flex flex-col space-y-6">
                ...
                <div className="space-y-4">
                  <div className="bg-[#0b1a2d]/55 border border-white/5 rounded-2xl p-6 relative overflow-hidden">
