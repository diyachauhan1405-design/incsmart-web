...
const faqCategories = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Our head office is in Surat, Gujarat, with regional offices in Mumbai, New Delhi, and Bengaluru. We deploy solutions pan-India and support clients across multiple geographical locations from a unified cloud platform.",
      },
      {
      ...
      <main className="flex-grow pt-20">
        ...
        <section className="relative py-20 border-b border-white/5 bg-[#07111D] overflow-hidden bg-grid-pattern">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white leading-[1.15] font-heading mb-6">
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          className="w-full px-4 sm:px-6 py-4 flex items-center justify-between text-left cursor-pointer gap-3"
                        >
                          <span className="text-xs sm:text-sm font-bold text-white pr-2 min-w-0 flex-1">
                            {faq.question}
                          </span>
                          {isOpen ? (
